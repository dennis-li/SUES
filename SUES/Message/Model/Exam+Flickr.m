...
{
    Exam *exam = nil;
    User *user = [User searchUserWithId:examDictionary[EXAM_WHOEXAM] inManagedObjectContext:context];
    NSString *name = examDictionary[EXAM_NAME];
    NSString *semesterID = examDictionary[EXAM_SEMESTERID];
    if (!examDictionary[EXAM_NAME]) {
        return nil;
    }
